...
stocks = {'Advanced Micro Devices, Inc.': '/quote/AMD?p=AMD',
 'NVIDIA Corporation': '/quote/NVDA?p=NVDA',
 'Apple Inc.': '/quote/AAPL?p=AAPL',
 'Snap Inc.': '/quote/SNAP?p=SNAP',
 'AMC Entertainment Holdings, Inc.': '/quote/AMC?p=AMC',
 'NIO Inc.': '/quote/NIO?p=NIO',
 'Nu Holdings Ltd.': '/quote/NU?p=NU',
 'Bank of America Corporation': '/quote/BAC?p=BAC',
 'Alibaba Group Holding Limited': '/quote/BABA?p=BABA',
 'Carnival Corporation & plc': '/quote/CCL?p=CCL',
 'Southwestern Energy Company': '/quote/SWN?p=SWN',
 "Macy's, Inc.": '/quote/M?p=M',
 'Grab Holdings Limited': '/quote/GRAB?p=GRAB',
 'DiDi Global Inc.': '/quote/DIDI?p=DIDI',
 'Ford Motor Company': '/quote/F?p=F',
 'Palantir Technologies Inc.': '/quote/PLTR?p=PLTR',
 'Nokia Oyj': '/quote/NOK?p=NOK',
 'Snowflake Inc.': '/quote/SNOW?p=SNOW',
 'Tesla, Inc.': '/quote/TSLA?p=TSLA',
 'SoFi Technologies, Inc.': '/quote/SOFI?p=SOFI',
 'Itaú Unibanco Holding S.A.': '/quote/ITUB?p=ITUB',
 'Farfetch Limited': '/quote/FTCH?p=FTCH',
 'American Airlines Group Inc.': '/quote/AAL?p=AAL',
 'Banco Bradesco S.A.': '/quote/BBD?p=BBD',
 'Nutanix, Inc.': '/quote/NTNX?p=NTNX'}
...
stocks_drop = dcc.Dropdown(id='dropdown_stocks',
                           options=[{'label': x, 'value': x} for x in stocks.keys()],
...
stocks_main =dbc.Container([
    html.Br(),
    html.P('Here are the real time values for the price, change, percentage change, volume and market capitalization:'),
    html.Br(),
html.Div([
        dbc.Col([
            html.Div([
                    html.H4('Price', style={'font-weight': 'normal'}),
                    html.H5(id='price_stocks',className='number-color')
                ], className='cool_box', style={'width': '33.33%'}),
            html.Div([
                    html.H4('Change', style={'font-weight': 'normal'}),
                    html.H5(id='change_stocks',className='number-color')
                ], className='cool_box', style = {'width': '33.33%'}),
             html.Div([
                html.H4('%Change', style={'font-weight': 'normal'}),
                html.H5(id='perc_change_stocks',className='number-color')
            ], className='cool_box',style = {'width': '33.33%'}),
    ...
    html.Div([
        dbc.Col([
            html.Div([
                ...
                html.H5(id='volume_stocks', className='number-color')
            ], className='cool_box', style={'width': '50%'}),
            html.Div([
                html.H4('Market Cap', style={'font-weight': 'normal'}),
                html.H5(id='market_cap_stocks', className='number-color')
            ], className='cool_box', style={'width': '50%'}),
        ], className='center', style={'display': 'flex'})
    ])])

stocks_expl = dbc.Container([
    html.Br(),
    dbc.Row([
        html.Br(),
...
html.Div([
    html.Div([
        ...
        dbc.RadioItems(id='time_picker_stocks',
        ...
        dbc.Row([
            ...
            dcc.Graph(id='stationarity_stocks', figure={}),
        ]),
        html.Br(),
        html.Br(),
        html.Br(),
  ...
  html.Div([
        dbc.Col([
            html.Div([
                    ...
                    html.H5(id='p_value_stocks',className='number-color')
                ], className='cool_box', style={'width': '25%'}),
            html.Div([
                    html.H4('Critical value 1%:', style={'font-weight': 'normal'}),
                    html.H5(id='critical1_stocks',className='number-color')
                ], className='cool_box', style = {'width': '25%'}),
             html.Div([
                html.H4('Critical value 5%:', style={'font-weight': 'normal'}),
                html.H5(id='critical5_stocks',className='number-color')
            ], className='cool_box',style = {'width': '25%'}),
	        html.Div([
                html.H4('Critical value 10%:', style={'font-weight': 'normal'}),
                html.H5(id='critical10_stocks',className='number-color')
            ], className='cool_box',style = {'width': '25%'}),
      ...
      dbc.Row([
        ...
        dbc.Row([
            ...
            dcc.Graph(id='candle_stocks', figure={}),
        ]),
    ])
])


stocks_tech = dbc.Container([
    html.Br(),
    dcc.Store(id='d2_stocks'),
    dcc.Store(id='df_indicators_stocks'),
    dbc.Row([
        html.Br(),
...
html.Div([
    html.Div([
        ...
        dbc.RadioItems(id='time_picker2_stocks',
    ...
    dbc.Row([
        dbc.Col([
            ...
            dcc.Dropdown(id='dropdown_volatility_stocks',
        ...
        dbc.Col([
            ...
            dcc.Dropdown(id='dropdown_momentum_stocks',
        ...
        dbc.Col([
            ...
            dcc.Dropdown(id='dropdown_trend_stocks',
    ...
    dbc.Row([
        dbc.Col([
            ...
            dcc.Dropdown(id='dropdown_volume_stocks',
    ...
    dcc.Graph(id='graph_volatility_stocks', figure={}),
    dcc.Graph(id='graph_momentum_stocks', figure={}),
    dcc.Graph(id='graph_trend_stocks', figure={}),
    dcc.Graph(id='graph_volume_stocks', figure={})
])

#----------------------------DROPDOWN  MODELS-----------------

models_drop=dcc.Dropdown(id='dropdown_models_stocks',
                 options=[{'label': x, 'value': x} for x in models.keys()],
                 value="Linear Regression",
                 style={'color': '#000000'})
#----------------------------BUTTONS MODELS-------------------------

button_models=dbc.RadioItems(id='hour_day_stocks',
...
button_price_models=dbc.RadioItems(id='price_stocks',
...
html.Div([
        dbc.Col([
            html.Div([
                    ...
                    html.H5(id='scal_rmse_stocks',className='number-color')
                ], className='cool_box', style={'width': '33.33%'}),
            html.Div([
                    html.H4('Original RMSE', style={'font-weight': 'normal'}),
                    html.H5(id='orig_rmse_stocks',className='number-color')
                ], className='cool_box', style = {'width': '33.33%'}),
             html.Div([
                html.H4(id='pred_string_stocks', style={'font-weight': 'normal'}),
                html.H5(id='today_pred_stocks',className='number-color')
            ], className='cool_box',style = {'width': '33.33%'}),
	], className='center',style = {'display': 'flex'})]),
html.Br(),
html.Br(),
html.Br(),
    dcc.Graph(id='model_graph_stocks', figure={})

])


# -------------------------------------------------- CREATING DIFFERENT SEPARATORS
stocks_tabs = html.Div(
    [
        dbc.Tabs(
            [
                dbc.Tab(label="Main", tab_id="main_stocks_sep", active_label_style={"color": "orange"}),
                dbc.Tab(label="Exploratory Analysis", tab_id="expo_stocks_sep", active_label_style={"color": "orange"}),
                dbc.Tab(label="Technical Analysis", tab_id="tech_stocks_sep", active_label_style={"color": "orange"}),
                dbc.Tab(label="Models", tab_id="models_stocks_sep", active_label_style={"color": "orange"}),

                dbc.Row(dbc.Col(width=12)),

            ],
            id="stocks_seps",
            active_tab="main_stocks_sep",
        ),
    ], className="mt-3"
)
# -------------------------------------------------- APP LAYOUT
...
html.Div([
    html.Div([
        html.Img(src='/assets/stocks header2.png', height='90px'),
    ], style={'width': '28%'}),
    html.Div([
        html.H1('Stocks',
                className='text-left mb-4'),
...
html.Br(),
    ...
    html.Div([
        html.Div([
            ...
            html.Div([
                stocks_drop], style={'width': '65%'})
        ], id='3th row', style={'display': 'flex', 'width': '62%'}),

        html.Div([
            html.Div([
                html.H6(
                    'A stock (also known as equity) is a security that represents the ownership of a fraction of a corporation. This entitles the owner of the stock to a proportion of the corporations assets and profits equal to how much stock they own.')
            ], style={'width': '95%'})
...
html.Br(),
    dbc.Row(
        dbc.Col(
            stocks_tabs, width=12), className="fr-1"),
    html.Div(id='stocks_data', children=[])

])
# -------------------------------------------CALLBACKS
@app.callback(
    Output('price_stocks', 'children'),
    Output('change_stocks', 'children'),
    Output('perc_change_stocks', 'children'),
    Output('volume_stocks', 'children'),
    Output('market_cap_stocks', 'children'),
    Input('dropdown_stocks', 'value'))

def choose_directory_stock(asset):
    site = stocks[asset]
    ...
    return price, change, perc_change, Volume, Market_cap

# ------------------------------------------------------------

stocks_sigla = {'Advanced Micro Devices, Inc.': 'AMD',
...
@app.callback(
    Output('d_stocks', 'dataframe'),
    Input('dropdown_stocks', 'value'),
    Input('time_picker_stocks', 'value'))

# --------------------------------------------------

def dataframes_assets1(asset, time):
    asset = stocks_sigla[asset]
...
@app.callback(
    Output('stationarity_stocks', 'figure'),
    Output('candle_stocks', 'figure'),
    Input('d_stocks', 'dataframe'),)
...
# --------------------------------------------------
@app.callback(
    Output('p_value_stocks', 'children'),
    Output('critical1_stocks', 'children'),
    Output('critical5_stocks', 'children'),
    Output('critical10_stocks', 'children'),
    Input('d_stocks', 'dataframe'))
...
@app.callback(
    Output('d2_stocks', 'dataframe'),
    Input('dropdown_stocks', 'value'),
    Input('time_picker2_stocks', 'value'))
...
@app.callback(
    Output('df_indicators_stocks', 'dataframe'),
    Input('d2_stocks', 'dataframe'))
...
@app.callback(
    Output('graph_volatility_stocks', 'figure'),
    Input('dropdown_volatility_stocks', 'value'),
    Input('df_indicators_stocks', 'dataframe'))
...
@app.callback(
    Output('graph_momentum_stocks', 'figure'),
    Input('dropdown_momentum_stocks', 'value'),
    Input('df_indicators_stocks', 'dataframe'))
...
@app.callback(
    Output('graph_trend_stocks', 'figure'),
    Input('dropdown_trend_stocks', 'value'),
    Input('df_indicators_stocks', 'dataframe'))
...
@app.callback(
    Output('graph_volume_stocks', 'figure'),
    Input('dropdown_volume_stocks', 'value'),
    Input('df_indicators_stocks', 'dataframe'))
...
@app.callback(
    Output('df_models_stocks', 'dataframe'),
    Output('pred_string_stocks', 'children'),
    Input('dropdown_stocks', 'value'),
    Input('hour_day_stocks', 'value'))
...
@app.callback(
    Output('scal_rmse_stocks', 'children'),
    Output('orig_rmse_stocks', 'children'),
    Output('model_graph_stocks', 'figure'),
    Output('today_pred_stocks', 'children'),
    Input('df_models_stocks', 'dataframe'),
    Input('dropdown_models_stocks', 'value'),
    Input('price_stocks', 'value'))
...
@app.callback(
    Output('comment_stocks', 'children'),
    Input('p_value_stocks', 'children'))
...
@app.callback(
    Output("stocks_data", "children"),
    [Input("stocks_seps", "active_tab")]
)

def seperator_switch(choice):
    if choice == "main_stocks_sep":
        return stocks_main
    elif choice == "expo_stocks_sep":
        return stocks_expl
    elif choice == "tech_stocks_sep":
        return stocks_tech
    elif choice == "models_stocks_sep":
        return stocks_model
